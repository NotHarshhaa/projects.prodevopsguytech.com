...
- <b id="Argo">Install and Configure ArgoCD (Master Machine)</b>
  ...
  ```
  - <b>Username: admin</b>
  - <b> Now, go to <mark>User Info</mark> and update your argocd password</b>
#
...
- <b id="Monitor">Install Helm Chart</b>
```bash
