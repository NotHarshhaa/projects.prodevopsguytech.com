---
title: "DevOps Project-41: Deploying Swiggy Clone with Terraform, Jenkins, SonarQube, Trivy & Docker"
summary: This end-to-end DevOps automation project demonstrates the complete CI/CD lifecycle for deploying a Swiggy clone web application onto an AWS EC2 instance. The pipeline is orchestrated by Jenkins and follows a robust DevSecOps methodology by integrating code quality scanning via SonarQube, vulnerability detection using Trivy, and containerized deployment through Docker. Infrastructure provisioning is managed entirely with Terraform, creating a production-ready automated workflow.
objective: To build a fully automated and security-focused CI/CD pipeline using open-source DevOps tools and deploy a working Swiggy clone web application to a live AWS EC2 instance. This hands-on project will enhance skills in CI/CD automation, infrastructure provisioning with Terraform, code quality assurance, vulnerability scanning, and containerized deployments, following DevSecOps best practices to bridge the gap between development and operations with enhanced security.
tone:
  - technical
  - hands-on
  - security-focused
